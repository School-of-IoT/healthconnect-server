...
v1Route.get("/"+adminkey, async (req, res) => {
...
// e-parameter: _id 
v1Route.get("/patient/:_id", async (req, res) => {
...
// e-parameter: user 
v1Route.get("/geo_locate/:user", async (req, res) => {
...
v1Route.get("/data", async (req, res) => {
...
v1Route.post("/patient/signup", async(req, res) => {
...
// e-parameter: _id 
// request body: patient object
v1Route.put("/patient/update/:_id", async (req, res) => {
...
// e-parameter:  
v1Route.delete("/patient/delete/:_id", async (req, res) => {
    try{
        const { _id } = req.params;
...
v1Route.get("/devtkn/create", async (req, res) => {
...
v1Route.get("/devtkn/portal", async (req, res) => {
...
v1Route.get("/devtkn/device", async (req, res) => {
...
v1Route.post("/node/create", async (req, res) => {
    try {
...
v1Route.get("/node/device", async (req, res) => {
    try {
...
// q-parameter: user, dev_token
// request body: healthData object
v1Route.put("/health/update", async (req, res) => {
    try {
...
v1Route.delete("/node/delete", async (req, res) => {
    try{
